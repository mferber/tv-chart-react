...
export const AppEnvironmentContext = createContext<AppEnvironmentType | null>(null)
...
export function AppEnvironmentContextProvider({ children }: { children: ReactNode }) {
...
export function useAppEnvironmentContext() {
  ...
  if (context === undefined) {
    throw new Error('useAppEnvironmentContext must be used within AppEnvironmentContextProvider');
  }
  return context;
}